<div class="notices">
	<ul>
		<li><a class="opener" href="#">Calendar events</a></li>
		<ul class="children">
			<li>
				<a class="opener onclick-popup" href="#">Today's Events</a>
				<div class="slide">
			...
			<li>
				<a href="<?php echo home_url(); ?>/ccgs-world-page/calendar">All Calendar Events</a>
			</li>
		</ul>
	</ul>
</div>
